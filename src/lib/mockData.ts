...
export const recipes = [
  {
    ...
    room: "Veg Room A",
    doses: [
      { nutrient: "Solution A", ml: 2.0 },
      { nutrient: "Solution B", ml: 2.0 },
      { nutrient: "Cal-Mag", ml: 1.0 },
    ],
  },
  {
    id: "rc2",
    ...
    room: "Flower Room 1",
    doses: [
      { nutrient: "Solution A", ml: 3.5 },
      { nutrient: "Solution B", ml: 3.5 },
      { nutrient: "Bloom Boost", ml: 2.0 },
      { nutrient: "Cal-Mag", ml: 0.5 },
    ],
  },
  {
    id: "rc3",
  ...
  },
  {
    ...
    room: "Clone Tent",
    doses: [
      { nutrient: "Solution A", ml: 0.8 },
      { nutrient: "Cal-Mag", ml: 0.4 },
    ],
  },
];
...
export const dosingLog = [
  {
    ...
    room: "Flower Room 1",
    recipe: "Bloom Week 5",
    doses: "A 35ml • B 35ml • Bloom 20ml",
  },
  {
    id: "d2",
    time: "09:15",
    ...
    room: "Veg Room A",
    recipe: "Veg Week 2",
    doses: "A 20ml • B 20ml • Cal-Mag 10ml",
  },
  {
    id: "d3",
    time: "07:00",
...
export const chatHistory = [
  { id: "c1", role: "user" as const, text: "Why is EC dropping in Flower Room 1?" },
  {
    id: "c2",
    role: "ai" as const,
    text: "EC dropped from 2.1 to 1.85 over the last 6h. Likely cause: plants are uptaking nutrients faster than expected at week 5 of flowering. Recommendation: increase Solution A & B dose by ~15% in your next cycle (currently 35ml → 40ml).",
  },
];
...
export const solutions = [
  {
    id: "s1",
    title: "pH is drifting upward",
    desc: "Add 0.5ml pH Down per liter to bring back to 6.0",
    severity: "warning",
  },
  {
    id: "s2",
    title: "VPD slightly high",
    desc: "Increase humidity by 5% to reach optimal 1.2 kPa",
    severity: "warning",
  },
];
