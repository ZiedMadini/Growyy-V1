...
function ActiveRun() {
  ...
  return (
    <MobileShell>
        ...
        <div className="glass rounded-3xl p-5 relative overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-ink-dim">{room.stage}</p>
            </div>
            ...
            <p className="text-[11px] text-ink-dim mt-2 font-num">{room.totalDays - room.day} days until harvest</p>
          </div>
        </div>
      </section>

      <section className="px-5 mt-6">
        <h3 className="text-[11px] font-semibold uppercase tracking-[0.18em] text-ink-dim mb-3">Live readings</h3>
      ...
      <section className="px-5 mt-6">
        <h3 className="text-[11px] font-semibold uppercase tracking-[0.18em] text-ink-dim mb-3">Recent events</h3>
        <div className="space-y-2">
          {recentEvents.map((e, i) => {
            ...
            return (
              ...
              >
                <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(46,168,74,0.12)" }}>
...
function Reading({ icon: Icon, label, v, u, d = 0 }: { icon: typeof Thermometer; label: string; v: number; u: string; d?: number }) {
  return (
