  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <path
          d="M 140 260 Q 140 240 200 240 Q 260 240 260 260 L 250 400 L 150 400 Z"
          fill="#2EA84A"
        />
        <rect x="172" y="240" width="56" height="20" rx="4" fill="#1a3a25" />
        <path
          d="M 145 280 Q 110 320 130 380"
          stroke="#e8c4a0"
          strokeWidth="14"
          fill="none"
          strokeLinecap="round"
        ...
        <motion.circle
          ...
          r="5"
          fill="#FF6B6B"
          animate={{ opacity: 0.3 + celebration * 0.4 }}
        />
        <motion.circle
          cx="220"
          cy="215"
